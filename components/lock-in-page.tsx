    ...
    <div className="p-4 sm:p-8 md:p-20 pb-0 overflow-hidden">
      <div>
        <Image
          ...
          width={400}
          height={400}
          className="w-full max-w-[260px] sm:max-w-[340px] md:max-w-[400px] h-auto"
          style={{ mixBlendMode: "difference" }}
        />
        <br />

        <h1 className="text-xl sm:text-2xl md:text-3xl font-sans leading-snug">
          I'm a web developer, obsessed with software.{" "}
        </h1>
      </div>
      ...
      <div className="mt-8 md:mt-10">
        <h1 className="text-xl sm:text-2xl md:text-3xl font-sans mb-3">
          Some of my work:
        </h1>
        <div className="space-y-1 flex flex-col items-start">
          ...
          <Link
            href="https://codingboyblah.itch.io/circle-pong"
            className="text-lg sm:text-xl md:text-2xl group relative inline-block py-1 min-h-[44px] flex items-center"
          >
            ...
            {blogs.length === 0 ? (
              ...
              [...blogs].reverse().map((blog, index) => (
                <Link
                  key={index}
                  href={`/blog/${blog.slug}`}
                  className="text-lg sm:text-xl md:text-2xl group relative py-1 min-h-[44px] flex items-center"
                >
