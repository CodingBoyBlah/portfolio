...
export function InterruptSection() {
  ...
  return (
    <>
      <div
        className="h-[12vh] md:h-[30vh] scroll-snap-item"
        style={{ backgroundColor: "#d9d9d6" }}
      />

      <motion.section
        className="min-h-[25vh] md:min-h-[40vh] flex items-center justify-center px-4 scroll-snap-item"
        style={{ backgroundColor: "#d9d9d6" }}
      ...
      >
        <p
          className="font-mono text-xl sm:text-2xl md:text-3xl lg:text-4xl tracking-wide text-center"
          style={{ color: "#262629" }}
        >
          oops.. anyways.
        </p>
