...
export function InterruptSection() {
  ...
  return (
    <>
      <div className="h-[30vh] scroll-snap-item" style={{ backgroundColor: "#262629" }} />
      ...
      >
        <p className="font-mono text-2xl md:text-3xl lg:text-4xl tracking-wide" style={{ color: "#d9d9d6" }}>
          oops.. anyways.
        </p>
      </section>
